...
//print(falcon.weapon)
print("This doesn't compile as falcon in an instance of Spaceship class whereas the weapons variable is of fighter class and as Spaceship class is a parent class of fighter i.e. it does not inherit the properties of fighter class as it is the parent class")
