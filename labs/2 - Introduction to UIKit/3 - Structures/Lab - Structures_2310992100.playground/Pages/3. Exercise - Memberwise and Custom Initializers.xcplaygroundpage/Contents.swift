...
print("Latiude is: \(somePlace.latitude) and longitude is: \(somePlace.longitude)")
...
var favoriteBook = Book(title: "How to kill your family", author: "Bella Mackie", pages: 290, price: 498.99)
/*:
...
//var firstInstance =  Laptop(screenSize = 14, yearPurchased = 2025)
//var secondInstance = Laptop(repaircount)
/*:
...
var someonesHeight = Height(inInches: 65)
...
var myHeight = Height(inCentimeters: 187)
