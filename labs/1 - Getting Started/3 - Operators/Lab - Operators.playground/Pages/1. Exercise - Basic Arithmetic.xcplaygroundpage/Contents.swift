...
print("The answer i expect is : 3")
...
let divionResult = double10/double3
print("It differs as it gives the value in decimal rather than rounding off to the nearest integer")
/*:
...
print(even%2)
print(odd%2)
print("We should use the remainder operator to check if it is divisable or not by a certain number or to simply find the remainder")
/*:
