...
struct User {
    var name: String
    var age: Int
    var height: Double // in centimeters or inches
    var weight: Double // in kilograms or pounds
    var activityLevel: Int // from 1 (low) to 10 (high)
}
//:  Create a variable instance of `User` and call it your name. Use the memberwise initializer to pass in information about yourself. Then print out a description of your `User` instance using the instance's properties.
var aniket = User(name: "Aniket", age: 20, height: 175.0, weight: 68.0, activityLevel: 8)
print("Name: \(aniket.name), Age: \(aniket.age), Height: \(aniket.height), Weight: \(aniket.weight), Activity Level: \(aniket.activityLevel)")
...
print("Meters: \(mile.meters), Feet: \(mile.feet)")

//:  Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
let someDistance = Distance(feet: 3280.84)
print("Feet: \(someDistance.feet), Meters: \(someDistance.meters)")
